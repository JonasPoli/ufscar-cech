...
final class Version20260825015708 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE qualis_journals (id INT AUTO_INCREMENT NOT NULL, title VARCHAR(500) NOT NULL, issn VARCHAR(50) DEFAULT NULL, normalized_issn VARCHAR(50) DEFAULT NULL, qualis VARCHAR(10) DEFAULT NULL, area VARCHAR(255) DEFAULT NULL, INDEX idx_journal_norm_issn (normalized_issn), INDEX idx_journal_qualis (qualis), INDEX idx_journal_title (title), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
